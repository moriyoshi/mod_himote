...
#line 293 "zend_ini_parser.y"
  ...
  case 7:
#line 302 "zend_ini_parser.y"
    { ZEND_INI_PARSER_CB(&(yyvsp[(1) - (1)]), NULL, NULL, ZEND_INI_PARSER_ENTRY, ZEND_INI_PARSER_ARG TSRMLS_CC); free(Z_STRVAL((yyvsp[(1) - (1)]))); }
    break;

  case 9:
#line 307 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 10:
#line 308 "zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); }
    break;

  case 11:
#line 312 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 12:
#line 313 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 13:
#line 314 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 14:
#line 315 "zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); }
    break;

  case 15:
#line 319 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 16:
#line 320 "zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); }
    break;

  case 17:
#line 324 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 18:
#line 325 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 19:
#line 326 "zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); }
    break;

  case 20:
#line 330 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 21:
#line 331 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 22:
#line 332 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(2) - (3)]); }
    break;

  case 23:
#line 333 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 24:
#line 334 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 25:
#line 335 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (4)]), &(yyvsp[(3) - (4)])); free(Z_STRVAL((yyvsp[(3) - (4)]))); }
    break;

  case 26:
#line 339 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 27:
#line 340 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 28:
#line 341 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(2) - (3)]); }
    break;

  case 29:
#line 342 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 30:
#line 343 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); free(Z_STRVAL((yyvsp[(2) - (2)]))); }
    break;

  case 31:
#line 344 "zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (4)]), &(yyvsp[(3) - (4)])); free(Z_STRVAL((yyvsp[(3) - (4)]))); }
    break;

  case 32:
#line 348 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 33:
#line 349 "zend_ini_parser.y"
    { zend_ini_do_op('|', &(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); }
    break;

  case 34:
#line 350 "zend_ini_parser.y"
    { zend_ini_do_op('&', &(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); }
    break;

  case 35:
#line 351 "zend_ini_parser.y"
    { zend_ini_do_op('~', &(yyval), &(yyvsp[(2) - (2)]), NULL); }
    break;

  case 36:
#line 352 "zend_ini_parser.y"
    { zend_ini_do_op('!', &(yyval), &(yyvsp[(2) - (2)]), NULL); }
    break;

  case 37:
#line 353 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(2) - (3)]); }
    break;

  case 38:
#line 357 "zend_ini_parser.y"
    { zend_ini_get_var(&(yyval), &(yyvsp[(2) - (3)]) TSRMLS_CC); free(Z_STRVAL((yyvsp[(2) - (3)]))); }
    break;

  case 39:
#line 361 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 40:
#line 362 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_RAW: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 41:
#line 363 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_NUMBER: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 42:
#line 364 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_STRING: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 43:
#line 365 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_WHITESPACE: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 44:
#line 369 "zend_ini_parser.y"
    { zend_ini_get_constant(&(yyval), &(yyvsp[(1) - (1)]) TSRMLS_CC); }
    break;

  case 45:
#line 370 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_RAW: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 46:
#line 371 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_NUMBER: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 47:
#line 372 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_STRING: '%s'\n", Z_STRVAL($1));*/ }
    break;

  case 48:
#line 373 "zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_WHITESPACE: '%s'\n", Z_STRVAL($1));*/ }
    break;


/* Line 1267 of yacc.c.  */
#line 1896 "zend_ini_parser.c"
      default: break;
    }
