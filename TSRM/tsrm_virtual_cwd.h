...
#else
# define himote_sys_stat stat
# define himote_sys_lstat lstat
# ifdef HAVE_SYMLINK
# define himote_sys_readlink(link, target, target_len) readlink(link, target, target_len)
# endif
#endif
...
#define REALPATH_CACHE_SIZE 0      /* disabled while himote.ini isn't loaded */
...
#define VCWD_STAT(path, buff) himote_sys_stat(path, buff)
