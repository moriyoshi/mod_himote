...
BEGIN_EXTERN_C()
HIMOTEAPI int spprintf( char **pbuf, size_t max_len, const char *format, ...) HIMOTE_ATTRIBUTE_FORMAT(printf, 3, 4);

HIMOTEAPI int vspprintf(char **pbuf, size_t max_len, const char *format, va_list ap) HIMOTE_ATTRIBUTE_FORMAT(printf, 3, 0);
END_EXTERN_C()
