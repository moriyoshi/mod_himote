/* main/himote_config.h.  Generated automatically by configure.  */
/* main/himote_config.h.in.  Generated automatically from configure.in by autoheader.  */
...
/*   */
/* #undef HIMOTE_APACHE_HAVE_CLIENT_FD */
...
/* fpm user name */
/* #undef HIMOTE_FPM_USER */

/* fpm group name */
/* #undef HIMOTE_FPM_GROUP */
...
/* #undef HIMOTE_HPUX_TIME_R */

/* Whether you have IRIX-style functions */
/* #undef HIMOTE_IRIX_TIME_R */
...
/*   */
#define HIMOTE_SAFE_MODE 0

/*   */
#define HIMOTE_SAFE_MODE 0

/*   */
#define HIMOTE_SAFE_MODE_EXEC_DIR "/usr/local/himote/bin"

/*   */
#define HIMOTE_SAFE_MODE_EXEC_DIR "/usr/local/himote/bin"

/*   */
#define HIMOTE_SIGCHILD 0
...
/*   */
/* #undef HIMOTE_CURL_URL_WRAPPERS */
...
/*   */
#define DB4_INCLUDE_FILE "/Users/moriyoshi/opt/db-4.8.30/include/db.h"
...
#define HIMOTE_ICONV_IMPL "libiconv"
...
/* Path to iconv.h */
#define HIMOTE_ICONV_H_PATH </usr/include/iconv.h>
...
/* #undef HIMOTE_ONIG_BAD_KOI8_ENTRY */
...
/*   */
#define HIMOTE_MYSQL_UNIX_SOCK_ADDR "/var/lib/mysql/mysql.sock"
...
/*   */
/* #undef HIMOTE_OCI8_DEF_DIR */

/*   */
/* #undef HIMOTE_OCI8_DEF_SHARED_LIBADD */
...
/*   */
/* #undef HIMOTE_PDO_OCI_CLIENT_VERSION */
...
/* Whether you want SPL (Standard HIMOTE Library) support */
#define HAVE_SPL 1
...
/* Have PDO */
#define HIMOTE_SQLITE2_HAVE_PDO 1
...
/* Whether HIMOTE has to use its own crypt_r for blowfish, des and ext des */
#define HIMOTE_USE_HIMOTE_CRYPT_R 1

/* Define if your system has fork/vfork/CreateProcess */
#define HIMOTE_CAN_SUPPORT_PROC_OPEN 1
...
/* HIMOTE build date */
#define HIMOTE_BUILD_DATE "2012-06-25"

/* hardcode for each of the cross compiler host */
#define HIMOTE_OS "Darwin"

/* hardcode for each of the cross compiler host */
#define HIMOTE_UNAME "Darwin chicwab.local 11.4.0 Darwin Kernel Version 11.4.0: Mon Apr 9 19:32:15 PDT 2012; root:xnu-1699.26.8~1/RELEASE_X86_64 x86_64"
...
/* To enable the is_nan, is_infinite and is_finite HIMOTE functions */
#ifdef NETWARE
	#define HAVE_ISNAN 1
	#define HAVE_ISINF 1
