...
/*
  ...
  | HIMOTE Version 5                                                        |
  +----------------------------------------------------------------------+
  | Copyright (c) 1997-2006 The HIMOTE Group                                |
  +----------------------------------------------------------------------+
...
static HIMOTE_INI_MH(OnUpdateTags)
{
	...
	for (key = himote_strtok_r(tmp, ",", &lasts);
			key;
			key = himote_strtok_r(NULL, ",", &lasts)) {
		char *val;
...
HIMOTE_INI_BEGIN()
	STD_HIMOTE_INI_ENTRY("url_rewriter.tags", "a=href,area=href,frame=src,form=,fieldset=", HIMOTE_INI_ALL, OnUpdateTags, url_adapt_state_ex, himote_basic_globals, basic_globals)
HIMOTE_INI_END()
...
#line 162 "url_scanner_ex.c"
yy4:
	++YYCURSOR;
#line 117 "url_scanner_ex.re"
	{ sep = separator; goto scan; }
#line 167 "url_scanner_ex.c"
yy6:
	++YYCURSOR;
#line 118 "url_scanner_ex.re"
	{ bash = p - 1; goto done; }
#line 172 "url_scanner_ex.c"
yy8:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 364 "url_scanner_ex.c"
{
	...
	++YYCURSOR;
#line 299 "url_scanner_ex.re"
	{ passthru(STD_ARGS); STATE = STATE_TAG; goto state_tag; }
#line 409 "url_scanner_ex.c"
yy15:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 300 "url_scanner_ex.re"
	{ passthru(STD_ARGS); goto state_plain; }
#line 419 "url_scanner_ex.c"
}
#line 301 "url_scanner_ex.re"


state_tag:	
	start = YYCURSOR;

#line 427 "url_scanner_ex.c"
{
	YYCTYPE yych;
	static const unsigned char yybm[] = {
		  0,   0,   0,   0,   0,   0,   0,   0, 
...
#line 480 "url_scanner_ex.c"
yy22:
	++YYCURSOR;
#line 307 "url_scanner_ex.re"
	{ passthru(STD_ARGS); goto state_plain_begin; }
#line 485 "url_scanner_ex.c"
yy24:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 567 "url_scanner_ex.c"
yy30:
	++YYCURSOR;
	yych = *YYCURSOR;
	goto yy37;
yy31:
#line 317 "url_scanner_ex.re"
	{ passthru(STD_ARGS); goto state_next_arg; }
#line 575 "url_scanner_ex.c"
yy32:
	++YYCURSOR;
#line 318 "url_scanner_ex.re"
	{ --YYCURSOR; STATE = STATE_ARG; goto state_arg; }
#line 580 "url_scanner_ex.c"
yy34:
	++YYCURSOR;
#line 319 "url_scanner_ex.re"
	{ passthru(STD_ARGS); goto state_plain_begin; }
#line 585 "url_scanner_ex.c"
yy36:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
yy40:
	...
	goto yy45;
yy41:
#line 325 "url_scanner_ex.re"
	{ passthru(STD_ARGS); handle_arg(STD_ARGS); STATE = STATE_BEFORE_VAL; goto state_before_val; }
#line 652 "url_scanner_ex.c"
yy42:
	++YYCURSOR;
#line 326 "url_scanner_ex.re"
	{ passthru(STD_ARGS); STATE = STATE_NEXT_ARG; goto state_next_arg; }
#line 657 "url_scanner_ex.c"
yy44:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
#line 760 "url_scanner_ex.c"
{
	...
	goto yy77;
yy61:
#line 342 "url_scanner_ex.re"
	{ handle_val(STD_ARGS, 0, ' '); goto state_next_arg_begin; }
#line 823 "url_scanner_ex.c"
yy62:
	yych = *(YYMARKER = ++YYCURSOR);
	goto yy69;
yy63:
...
yy64:
	++YYCURSOR;
#line 343 "url_scanner_ex.re"
	{ passthru(STD_ARGS); goto state_next_arg_begin; }
#line 834 "url_scanner_ex.c"
yy66:
	++YYCURSOR;
	if (YYLIMIT <= YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
char *himote_url_scanner_adapt_single_url(const char *url, size_t urllen, const char *name, const char *value, size_t *newlen TSRMLS_DC)
{
	smart_str surl = {0};
	smart_str buf = {0};
	smart_str url_app = {0};
...
static int himote_url_scanner_ex_activate(TSRMLS_D)
{
	url_adapt_state_ex_t *ctx;
...
static int himote_url_scanner_ex_deactivate(TSRMLS_D)
{
	url_adapt_state_ex_t *ctx;
...
static void himote_url_scanner_output_handler(char *output, uint output_len, char **handled_output, uint *handled_output_len, int mode TSRMLS_DC)
{
	size_t len;

	if (BG(url_adapt_state_ex).url_app.len != 0) {
		*handled_output = url_adapt_ext(output, output_len, &len, (zend_bool) (mode & (HIMOTE_OUTPUT_HANDLER_END | HIMOTE_OUTPUT_HANDLER_CONT) ? 1 : 0) TSRMLS_CC);
...
HIMOTEAPI int himote_url_scanner_add_var(char *name, int name_len, char *value, int value_len, int urlencode TSRMLS_DC)
{
	...
	if (! BG(url_adapt_state_ex).active) {
		himote_url_scanner_ex_activate(TSRMLS_C);
		himote_ob_set_internal_handler(himote_url_scanner_output_handler, 0, "URL-Rewriter", 1 TSRMLS_CC);
	...
	if (urlencode) {
		encoded = himote_url_encode(value, value_len, &encoded_len);
...
HIMOTE_MINIT_FUNCTION(url_scanner)
{
...
HIMOTE_MSHUTDOWN_FUNCTION(url_scanner)
{
...
HIMOTE_RINIT_FUNCTION(url_scanner)
{
...
HIMOTE_RSHUTDOWN_FUNCTION(url_scanner)
{
	if (BG(url_adapt_state_ex).active) {
		himote_url_scanner_ex_deactivate(TSRMLS_C);
		BG(url_adapt_state_ex).active = 0;
	}
