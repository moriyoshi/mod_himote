...
static zend_object_handlers himote_incomplete_object_handlers;
...
static void incomplete_class_message(zval *object, int error_type TSRMLS_DC)
{
	...
	class_name = himote_lookup_class_name(object, NULL);
	...
	himote_error_docref(NULL TSRMLS_CC, error_type, INCOMPLETE_CLASS_MSG, class_name);
...
/* {{{ himote_create_incomplete_class
 */
static zend_object_value himote_create_incomplete_object(zend_class_entry *class_type TSRMLS_DC)
{
	zend_object *object;
	zend_object_value value;
	
	value = zend_objects_new(&object, class_type TSRMLS_CC);
	value.handlers = &himote_incomplete_object_handlers;
...
HIMOTEAPI zend_class_entry *himote_create_incomplete_class(TSRMLS_D)
{
	...
	incomplete_class.create_object = himote_create_incomplete_object;

	memcpy(&himote_incomplete_object_handlers, &std_object_handlers, sizeof(zend_object_handlers));
	himote_incomplete_object_handlers.read_property = incomplete_class_get_property;
	himote_incomplete_object_handlers.has_property = incomplete_class_has_property;
	himote_incomplete_object_handlers.unset_property = incomplete_class_unset_property;
	himote_incomplete_object_handlers.write_property = incomplete_class_write_property;
	himote_incomplete_object_handlers.get_property_ptr_ptr = incomplete_class_get_property_ptr_ptr;
    himote_incomplete_object_handlers.get_method = incomplete_class_get_method;
	
	return zend_register_internal_class(&incomplete_class TSRMLS_CC);
}
/* }}} */

/* {{{ himote_lookup_class_name
 */
