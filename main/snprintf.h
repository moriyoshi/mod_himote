...
HIMOTEAPI int ap_himote_snprintf(char *, size_t, const char *, ...);
HIMOTEAPI int ap_himote_vsnprintf(char *, size_t, const char *, va_list ap);
...
HIMOTEAPI int himote_sprintf (char* s, const char* format, ...) HIMOTE_ATTRIBUTE_FORMAT(printf, 2, 3);
...
#undef slprintf
#endif
#define slprintf ap_himote_slprintf

#ifdef vslprintf
#undef vslprintf
#endif
#define vslprintf ap_himote_vslprintf

#ifdef snprintf
#undef snprintf
#endif
#define snprintf ap_himote_snprintf

#ifdef vsnprintf
#undef vsnprintf
#endif
#define vsnprintf ap_himote_vsnprintf

#ifndef HAVE_VASPRINTF
#define vasprintf ap_himote_vasprintf
#endif

#ifndef HAVE_ASPRINTF
#define asprintf ap_himote_asprintf
#endif
...
extern char * ap_himote_conv_10(register wide_int num, register bool_int is_unsigned,
	   register bool_int * is_negative, char *buf_end, register int *len);

extern char * ap_himote_conv_p2(register u_wide_int num, register int nbits,
 ...
 * another level (see NDIG in himote_conv_fp()).
